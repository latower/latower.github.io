...
- **Roxana Băcălie** (2025-26; Satellite Constellation Design), co-supervised with dr. Neil Yorke-Smith (TU Delft, Algorithmics) and dr. Max Bannach (ESA, Advanced Concepts Team). [LinkedIn](https://www.linkedin.com/in/ioana-roxana-bacalie/), [github](https://github.com/roxanabacalie).
- **Sreevidya Iyer** (2025-26; Social Network Anonymisation), co-supervised with dr. Emir Demirović (TU Delft, Algorithmics). [LinkedIn](https://www.linkedin.com/in/sreevidyaiyer), [github](https://github.com/sreevidyaiyer).

### FORMER

- **Roy Katz** (2024-25; Nurse Rostering), co-supervised with dr. Neil Yorke-Smith (TU Delft, Algorithmics) and ORTEC. Thesis: [Adding Ejection Chain to Nurse Rostering Simulated Annealing Solver](https://repository.tudelft.nl/record/uuid:90eb4f66-b159-4b38-ae64-e929985f2cae). Other: [defence](/posts/2025/06/roy-defends/).
- **Andrei Mereuţa** (2024-25; Recipe Recommendation), co-supervised with dr. Neil Yorke-Smith (TU Delft, Algorithmics) and Picnic. Thesis: [Multi-Meal, Multi-Constraint Recommender System to Optimize Grocery Budget and Waste](https://repository.tudelft.nl/record/uuid:b524f5bc-c283-4fa3-9906-4d5f4899d0e5). Other: [defence](/posts/2025/06/andrei-defends/).
